...
export default function PatientDetailsScreen({ navigation, route }: any) {
  ...
  return (
    <SafeAreaView style={common.screen} edges={["top"]}>
      <ScreenHeader title="Patient Details" onBack={() => navigation.goBack()} rightIcon="ellipsis-vertical" />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={[common.card, common.row, styles.infoCard]}>
          ...
          <View style={styles.infoText}>
            ...
            <Text style={common.subtitle}>{patient.gender}, {patient.age} years</Text>
          </View>
          <TouchableOpacity style={styles.chatIcon} onPress={() => navigation.navigate("Chat", { patient })}>
            <Ionicons name="chatbubble-ellipses-outline" size={22} color={colors.main} />
          </TouchableOpacity>
        </View>

        <Text style={[common.title, styles.sectionTitle]}>Diagnosis Analysis</Text>
        ...
        <View style={styles.predictionBox}>
          ...
          <View style={[common.row, styles.badgeRow]}>
            <View style={[common.row, styles.severityBadge, { backgroundColor: sev.bg }]}>
            ...
            <View style={[common.row, styles.followBadge]}>
              <Ionicons name="information-circle-outline" size={12} color={colors.main} />
              <Text style={styles.followText}>Follow-up Required</Text>
            </View>
          </View>
          <View style={[common.row, { gap: 10 }]}>
            <TouchableOpacity style={styles.reportBtn} onPress={() => navigation.navigate("DiagnosisReport", { patient })}>
              <Text style={styles.reportBtnText}>View Full Report</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.shareBtn}>
              <Ionicons name="share-social-outline" size={20} color={colors.main} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={[common.card, styles.notesCard]}>
          ...
          <Text style={[common.subtitle, { lineHeight: 20 }]}>"{patient.notes}"</Text>
...
const styles = StyleSheet.create({
  ...
  aiLabel: { fontSize: 11, fontWeight: "700", color: colors.main, letterSpacing: 0.5 },
  confidence: { fontSize: 18, fontWeight: "700", color: colors.main },
  conditionName: { fontSize: 24, fontWeight: "700", color: colors.black, marginVertical: 6 },
  badgeRow: { gap: 10, marginBottom: 14 },
  severityBadge: { gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  severityText: { fontSize: 12, fontWeight: "600" },
  followBadge: { gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20, backgroundColor: "#EAF0FF" },
  followText: { fontSize: 12, fontWeight: "600", color: colors.main },
  reportBtn: { flex: 1, backgroundColor: "#EAF0FF", borderRadius: 12, paddingVertical: 12, alignItems: "center" },
